...
class WithdrawService(
    ...
    fun withdraw(accountId: UUID) {
        ...
        exec("delete from feed_post_hearts where account_id = :id or post_id in (select id from feed_posts where author_account_id = :id)", accountId)
        exec("delete from feed_posts where author_account_id = :id", accountId)
        ...
        exec("delete from answer_unlocks where account_id = :id", accountId)
