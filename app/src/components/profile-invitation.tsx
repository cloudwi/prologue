...
const styles = StyleSheet.create({
  ...
  // 폭만 제한하고 높이는 각 원본 비율이 정한다. 화면이 사진을 같은 틀에 억지로 맞추지 않는다.
  photo: { alignSelf: 'center', width: '82%', maxWidth: 400, aspectRatio: 4 / 5, borderRadius: Radius.md },
