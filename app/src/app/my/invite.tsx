...
const styles = StyleSheet.create({
  ...
  copyHint: { fontSize: 13, textAlign: 'center', marginTop: 2 },
  desc: { fontSize: 14.5, lineHeight: 21, textAlign: 'center', marginTop: 14 },
  ...
  count: { fontSize: 13.5, marginTop: 14, textAlign: 'center' },
  ...
  redeemText: { fontSize: 16, fontWeight: '700' },
});
