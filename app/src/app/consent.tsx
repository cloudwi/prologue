...
const styles = StyleSheet.create({
  ...
  allText: { fontSize: 16, fontWeight: '700' },
  ...
  itemLabel: { fontSize: 14, flex: 1, lineHeight: 20 },
  view: { fontSize: 13, textDecorationLine: 'underline' },
  note: { fontSize: 12, lineHeight: 18, marginTop: 6, marginLeft: 34 },
  box: {
    width: 22,
    height: 22,
    borderRadius: 6,
  ...
  check: { fontSize: 13, fontWeight: '900', lineHeight: 16 },
