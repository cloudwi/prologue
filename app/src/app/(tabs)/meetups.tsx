...
const styles = StyleSheet.create({
  ...
  cardMeta: { fontSize: 13, marginTop: 5 },
  hostLine: { fontSize: 12.5, marginTop: 8, fontWeight: '600' },
  cardDesc: { fontSize: 14.5, lineHeight: 22, marginTop: 12 },
  ...
  applyBtnText: { fontSize: 14.5, fontWeight: '700' },
  cancelLink: { fontSize: 13, textDecorationLine: 'underline' },
  appliedNote: { fontSize: 13, lineHeight: 19, marginTop: 12, fontWeight: '600' },
  ...
  kakaoBtnText: { fontSize: 13, fontWeight: '600' },
  ...
  historyTitle: { fontSize: 14.5, fontWeight: '700' },
  historyMeta: { fontSize: 12, marginTop: 2 },
  historyCount: { fontSize: 12.5, fontWeight: '700' },
