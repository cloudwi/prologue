...
export const DEMO_PROFILES: DemoProfile[] = [
  {
    ...
    photos: [
      require('../../assets/images/demo-profiles/demo-afternoonwalk-1-v3.jpg'),
      require('../../assets/images/demo-profiles/demo-afternoonwalk-2-v3.jpg'),
      require('../../assets/images/demo-profiles/demo-afternoonwalk-3-v3.jpg'),
    ],
  ...
  },
  {
    ...
    photos: [
      require('../../assets/images/demo-profiles/demo-hangang-1-v3.jpg'),
      require('../../assets/images/demo-profiles/demo-hangang-2-v3.jpg'),
      require('../../assets/images/demo-profiles/demo-hangang-3-v3.jpg'),
    ],
    hobbies: ['러닝', '요리', '맛집'],
    interests: ['건강', '음식'],
    strengths: ['긍정적', '책임감'],
  ...
  },
  {
    ...
    photos: [
      require('../../assets/images/demo-profiles/demo-bookmark-1-v3.jpg'),
      require('../../assets/images/demo-profiles/demo-bookmark-2-v3.jpg'),
      require('../../assets/images/demo-profiles/demo-bookmark-3-v3.jpg'),
    ],
    hobbies: ['독서', '사진', '여행'],
    interests: ['문화예술', '글쓰기'],
